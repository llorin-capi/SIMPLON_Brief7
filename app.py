...
def index():
    participants = [donnees_pokemon() for _ in range(16)]
    print(f"Participants sélectionnés : {participants}")  # Ajout du print pour vérifier les données
    ...
    print(f"Rounds générés : {rounds}")  # Print pour vérifier les rounds générés
    winner = participants[0]
    print(f"Gagnant final : {winner}")  # Print pour vérifier le gagnant
